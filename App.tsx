...
function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-accent-gold/30 selection:text-white font-sans">
      ...
      <main>
        {/* HERO */}
        <section className="relative min-h-[90vh] md:min-h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-12 md:space-y-20 animate-in fade-in slide-in-from-bottom-12 duration-1000 relative z-10">
                <div className="space-y-6 md:space-y-8">
                    <div className="text-white/20 text-[10px] font-bold tracking-[1.2em] uppercase">Teacher • Developer • School App Builder</div>
                    
                    <h1 className="text-4xl md:text-7xl lg:text-8xl font-light tracking-tighter text-white leading-[1.1] md:leading-[1.05] font-display text-gradient-white py-2">
                      Tools for you, <br />
                      <span className="italic text-white/40 block mt-2 md:mt-4">
                        by you.
                      </span>
                    </h1>

                    <p className="text-[10px] md:text-xs text-white/20 max-w-sm mx-auto leading-relaxed font-light tracking-[0.4em] uppercase pt-4 md:pt-8">
            ...
            <div className="absolute bottom-8 md:bottom-20 left-1/2 -translate-x-1/2 opacity-10 flex flex-col items-center gap-4 md:gap-8 animate-in fade-in slide-in-from-top-4 duration-1000 delay-500">
              <span className="text-[7px] uppercase tracking-[1em] font-bold">Scroll</span>
              <div className="w-[1px] h-12 md:h-24 bg-gradient-to-b from-white to-transparent"></div>
            </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-16">
              {PORTFOLIO_DATA.impactMetrics.map((metric, i) => (
                <div key={i} className="text-center md:text-left space-y-2 group">
                  <div className="text-3xl md:text-5xl font-light text-white font-display tracking-tight leading-none group-hover:text-accent-gold transition-colors duration-700">{metric.value}</div>
        ...
        {/* PORTFOLIO */}
        <section id="portfolio" className="py-32 md:py-64 px-6 max-w-6xl mx-auto">
            <div className="mb-24 md:mb-48 text-center space-y-6">
                ...
                <h2 className="text-4xl md:text-6xl font-light tracking-tight text-white font-display">Featured Projects</h2>
        ...
        {/* LAB */}
        <section id="lab" className="py-32 md:py-64 relative overflow-hidden bg-white/[0.01]">
            <div className="text-center mb-20 md:mb-32 px-6 space-y-8 relative z-10">
                <div className="text-white/20 text-[10px] font-bold tracking-[1em] uppercase">02 / Lab</div>
                <h2 className="text-4xl md:text-6xl font-light text-white font-display tracking-tight">The Solution Lab</h2>
                <p className="text-white/30 text-[10px] max-w-sm mx-auto font-light leading-relaxed tracking-widest uppercase">
        ...
        {/* PROFILE */}
        <section id="about" className="py-32 md:py-64 px-6 max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 md:gap-40">
            <div className="space-y-12 md:space-y-16">
               ...
               <h2 className="text-5xl md:text-7xl font-light text-white font-display leading-[1.1] tracking-tighter">Teacher turned <br /><span className="text-white/20 italic">developer.</span></h2>
               ...
               <div className="space-y-8 pt-6">
                  <div className="border-l border-white/10 pl-10 py-2 group hover:border-accent-gold/60 transition-all duration-700">
                    <div className="text-white/90 font-medium text-lg tracking-tight">Master of Education</div>
                    <div className="text-white/15 text-[10px] tracking-[0.4em] uppercase mt-3">Curriculum Design</div>
                  </div>
                  <div className="border-l border-white/10 pl-10 py-2 group hover:border-accent-gold/60 transition-all duration-700">
                    <div className="text-white/90 font-medium text-lg tracking-tight">Bachelor of Laws</div>
                    <div className="text-white/15 text-[10px] tracking-[0.4em] uppercase mt-3">Legal Logic</div>
                  </div>
               </div>
            </div>

            <div className="grid grid-cols-1 gap-10 glass-panel p-8 md:p-16 rounded-[3rem] bg-white/[0.01]">
               <div className="text-white/20 text-[10px] font-bold uppercase tracking-[0.8em] mb-2">My Skills</div>
               <div className="space-y-8">
                {PORTFOLIO_DATA.skills.map(skill => (
                    <div key={skill.name} className="space-y-4">
                      <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-[0.4em] text-white/50">
        ...
        {/* CONTACT */}
        <section id="contact" className="py-48 md:py-80 px-6 text-center border-t border-white/5 bg-gradient-to-b from-transparent to-black/40">
            <div className="max-w-4xl mx-auto space-y-12 md:space-y-16">
                <div className="text-accent-gold text-[10px] font-bold tracking-[1.2em] uppercase">Get In Touch</div>
                <h2 className="text-6xl md:text-8xl lg:text-9xl font-light text-white font-display tracking-tighter leading-none opacity-90">Let's build.</h2>
                ...
                <div className="flex justify-center pt-8">
                    <a href="mailto:jsn.benjamin@gmail.com" className="shiny-cta px-12 md:px-20 py-7 md:py-9 text-[11px] tracking-[0.5em]">
                        <MailIcon className="w-5 h-5 mr-4 opacity-40" />
                        Send a Message
                    </a>
                </div>
            </div>
      ...
      <footer className="py-20 text-center bg-black/80 border-t border-white/5">
          <p className="text-[10px] text-white/10 font-bold uppercase tracking-[1em]">
