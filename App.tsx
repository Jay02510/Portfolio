...
function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-accent-gold/30 selection:text-white font-sans">
      ...
      <main>
        {/* HERO */}
        <section className="relative min-h-screen flex flex-col items-center justify-between px-6 text-center overflow-hidden pt-40 pb-12">
            {/* 3D Background Asset - Visual Pop */}
            <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center">
                <div className="absolute w-[120vw] h-[120vh] bg-[#0d0f14] z-[-1]"></div>
                {/* Abstract 3D Render to provide depth */}
                <img 
                  src="https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=2560&auto=format&fit=crop" 
                  className="absolute w-full h-full object-cover opacity-20 mix-blend-screen scale-110 animate-drift"
                  alt=""
                />
                <div className="absolute inset-0 bg-gradient-to-b from-alpine-950 via-transparent to-alpine-950"></div>
                
                {/* Floating Glows */}
                <div className="absolute top-[20%] left-[15%] w-[40rem] h-[40rem] bg-accent-gold/10 rounded-full blur-[120px] animate-float-slow opacity-30"></div>
                <div className="absolute bottom-[20%] right-[10%] w-[35rem] h-[35rem] bg-white/5 rounded-full blur-[100px] animate-drift opacity-20"></div>
            </div>

            <div className="max-w-7xl mx-auto space-y-24 md:space-y-32 animate-in fade-in slide-in-from-bottom-12 duration-1000 relative z-10 flex-1 flex flex-col justify-center">
                <div className="space-y-10 md:space-y-14">
                    <div className="flex items-center justify-center gap-4 text-white/30 text-[10px] font-bold tracking-[0.8em] uppercase">
                      TEACHER <span className="text-accent-gold/30">•</span> DEVELOPER <span className="text-accent-gold/30">•</span> APP BUILDER
                    </div>
                    
                    <div className="relative inline-block py-2">
                      <h1 className="text-6xl md:text-8xl lg:text-9xl font-light tracking-tighter text-white leading-tight font-display text-gradient-white">
                        Tools for you, <br />
                        <span className="italic text-white/40 block mt-6 md:mt-8 tracking-tighter">
                          by you.
                        </span>
                      </h1>
                    </div>

                    <p className="text-[10px] md:text-xs text-white/30 max-w-sm mx-auto leading-relaxed font-light tracking-[0.4em] uppercase pt-10">
                      Simple tools for smarter schools.
                    </p>
                </div>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-16">
                    <a href="#portfolio" onClick={scrollToSection('portfolio')} className="shiny-cta min-w-[280px] md:min-w-[320px] group">
                        Browse My Tools
            ...
            {/* Scroll Indicator - repositioned to prevent collision */}
            <div className="relative z-10 opacity-20 flex flex-col items-center gap-6 animate-in fade-in slide-in-from-top-4 duration-1000 delay-500 mt-20">
              <span className="text-[7px] uppercase tracking-[1em] font-bold">Scroll Down</span>
              <div className="w-[1px] h-12 md:h-20 bg-gradient-to-b from-white/40 to-transparent"></div>
            </div>
        </section>
        ...
        {/* PORTFOLIO */}
        <section id="portfolio" className="py-48 md:py-80 px-6 max-w-6xl mx-auto">
            <div className="mb-32 md:mb-64 text-center space-y-8">
            ...
            <div className="space-y-[20rem] md:space-y-[32rem]">
        ...
        {/* LAB */}
        <section id="lab" className="py-48 md:py-80 relative overflow-hidden bg-white/[0.01]">
            <div className="text-center mb-24 md:mb-40 px-6 space-y-10 relative z-10">
        ...
        {/* PROFILE */}
        <section id="about" className="py-48 md:py-80 px-6 max-w-6xl mx-auto">
        ...
        {/* CONTACT */}
        <section id="contact" className="py-64 md:py-96 px-6 text-center border-t border-white/5 bg-gradient-to-b from-transparent to-black/40">
