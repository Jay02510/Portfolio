...
const t = {
  en: {
    ...
    hoursSavedLabel: "Est. Admin Workload Saved",
    hoursSavedValue: "80%",
    ...
    integrityBadge: "Live Production Apps · Metrics Under Active Verification",
  ...
  ko: {
    ...
    integrityBadge: "라이브 프로덕션 앱 · 지표 검증 진행 중",
    sayHi: "프로젝트 협업 문의",
