  ...
  const t = {
    en: {
      ...
      roles: [
        {
          ...
          bulletPoints: [
            "Product 1 (Chekki B2B Command Center - Enterprise SaaS): Defined the product strategy for a B2B educational portal to eliminate 15+ hours of weekly admin overhead; shipped strict RBAC & Magic Link authentication to reduce onboarding friction; designed Make.com & Google Gemini pipeline translating qualitative behavior observations into bilingual consultation notes, driving an 80% workload reduction.",
            "Product 2 (Chekki AI - Consumer Mobile App): Led end-to-end product lifecycle on Apple App Store & Vercel targeting Korean families & teachers; designed zero-storage privacy architecture as a core product requirement, eliminating sensitive child data retention and ensuring full App Store safety & COPPA compliance; shipped international GTM strategy.",
            "Product 3 (Learning Diary - Bilingual Student Portfolio Compiler): Shipped touch-screen 'Tag & Commit' AI portfolio tool; designed Dynamic Tenant Theming allowing directors to configure custom branding, logos (preserving ratio with object-fit), and localized font sets; built zero-trust multi-tenant PG Supabase database with RLS; shipped client-side @react-pdf/renderer compiler to keep server costs at $0.",
            "Product 4 (EduPlanner Pro - AI Scheduling Engine): Shipped an automated school scheduling engine eliminating manual room mapping, curriculum minimums, and cognitive loads; designed 'Draft & Weave' two-stage LLM pipeline (Gemini Flash as fast pass and Gemini Pro fallback for constraint recalculations); defined metrics around conflict resolution rate.",
            "Product 5 (Benchmark AI - Continuous ESL Assessment Suite): Shipped responsive continuous assessment platform mapping student mastery growth directly to international standards (CEFR / Cambridge YLE), enabling early intervention and data-driven decisions by teachers.",
            "Product 6 (B2B Lead Generator - Sales CRM & Outreach Engine): Designed a B2B sales tool parsing unstructured Naver Maps directory data and using generative AI to produce hyper-personalized outreach campaigns, scaling ESL client acquisition without additional sales headcount."
          ]
        },
        {
      ...
      skills: [
        ...
        { category: "AI & Generative AI", items: ["Generative AI", "LLM Integration", "AI Agent Design", "Prompt Engineering", "Google Gemini (Flash / Pro)", "Claude AI", "Google AI Studio", "Bilingual AI", "Responsible AI", "Model Bias Mitigation", "Structured JSON Schema Enforcement", "Prompt Injection Hardening"] },
    ...
    ko: {
      ...
      skills: [
        ...
        { category: "AI & Generative AI (LLM 응용)", items: ["생성형 AI 시스템 설계", "LLM 결합 엔지니어링", "AI 에이전트 오토메이션", "프롬프트 아키텍팅", "Google Gemini Flash/Pro", "Claude AI 연동", "Google AI Studio 활용", "이중언어 AI 특화", "책임감 있는 AI 배포", "편향 제거 설계", "정형 JSON 스키마 주입 및 보정", "프롬프트 인젝션 보안 배리어 구축"] },
