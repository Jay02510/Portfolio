...
The projects showcased here (Benchmark Explorer, EduPlanner, etc.) are currently in Public Beta or MVP (Minimum Viable Product) status. Chekki AI is now live and subject to its own terms. These tools are provided "AS IS" and "AS AVAILABLE" without any warranties, express or implied.
...
1. 베타/MVP 공개 고지
본 포트폴리오에 소개된 프로젝트(Benchmark Explorer, EduPlanner 등)는 현재 공개 베타 또는 MVP(최소 기능 제품) 단계에 있습니다. Chekki AI는 현재 정식 서비스 중이며 해당 서비스의 약관을 따릅니다. 본 서비스는 명시적 또는 묵시적인 보증 없이 "있는 그대로" 그리고 "이용 가능한 상태로" 제공됩니다.
...
사용자는 AI 어시스턴트나 도구를 사용하여 유해하거나 불법적이거나 공격적인 콘텐츠를 생성하지 않을 것에 동의합니다. 당사는 본 약관을 위반하는 사용자의 접근을 제한할 권리를 보유합니다.
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-6 md:p-12">
      ...
      <div className="relative w-full max-w-2xl bg-alpine-950 border border-white/10 rounded-2xl overflow-hidden flex flex-col max-h-[80vh]">
        {/* Header */}
