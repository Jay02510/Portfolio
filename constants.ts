...
export const PORTFOLIO_DATA = {
  ...
  impactMetrics: [
    ...
    { label: "Admin Workload Reduction", value: "Est. 80% Reduction", icon: "zap" },
    { label: "Scheduling Automation", value: "MVP: 40h → 10min (0 Conflicts)", icon: "clock" },
  ...
  en: {
    ...
    projects: [
      {
        id: "vodabi",
        title: "VODABI — AI Outbound Sales Call Screening & Evaluation Platform",
        pmRole: "AI Product Manager & Engineer (Enterprise Voice-AI & LLM Judges)",
        category: "Tools" as const,
        description: "Enterprise voice-AI platform that replaces manual phone screens for outbound telemarketing candidates with real-time WebRTC AI persona roleplay and deterministic 11-rubric scoring.",
        longDescription: "Architected an end-to-end voice-AI platform in NestJS 11 and React 19. Candidates join a live real-time voice roleplay call with an AI persona via a secure magic link (no account needed, Direct WebRTC to OpenAI Realtime with <200ms latency and server-side VAD). Post-call, an async pipeline evaluates the call against 11 granular rubric codes, extracting BANTCQ qualification evidence, WPM speech pacing telemetry, and automated 2-week onboarding roadmaps. Includes a multi-tenant admin backoffice with custom RolesGuard and the VOISOR coaching assistant. *Proprietary client identifiers sanitized under NDA.*",
        ...
        flow: "Direct WebRTC audio streaming, Push-to-Talk & server VAD, post-call GPT-4o 11-rubric evaluation, stateless magic links with token rotation, and multi-tenant admin backoffice.",
        impactLabel: "Voice Architecture",
        impactValue: "Direct WebRTC (<200ms Latency)",
        ...
        engineDetails: "Tech Stack: React 19, TypeScript, Vite, NestJS 11, Prisma ORM 7 (MariaDB Driver Adapter), Direct WebRTC, OpenAI Realtime (gpt-4o-realtime-preview) + Post-Call GPT-4o, Docker Compose, Nginx, i18next",
        features: [
          "Realtime Voice Engine: Direct WebRTC streaming with ephemeral tokens, push-to-talk & server VAD (<200ms latency)",
          "11-Code Rubric Evaluation: Post-call GPT-4o async scoring for BANTCQ, behavioral criteria & WPM speech pacing",
          "VOISOR AI Coaching Assistant: Embedded chat widget grounded strictly in applicant evaluation reports",
          "Security & Magic Link Auth: Stateless tokenized links with auto-rotation on re-invite for zero-account applicant access",
          "Multi-Tenant RBAC Backoffice: React 19 console with tiered scenario rubrics, staff onboarding queues & official test assignment"
        ],
        tags: ["VodaBi B2B SaaS", "React 19", "WebRTC", "NestJS 11", "Prisma 7", "OpenAI Realtime", "GPT-4o"],
        imageUrl: "https://images.unsplash.com/photo-1589254065878-42c9da997008?q=80&w=2000&auto=format&fit=crop",
      },
      {
        id: "chekki-teacher",
        title: "Chekki Schools — Curriculum Pre-seeding & Classroom Mistake Aggregator",
        ...
        impactValue: "Est. 80% Grading Time Saved",
        collaborationUrl: "mailto:jsn.benjamin@gmail.com?subject=Chekki%20Schools%20Pilot%20Waitlist",
        maturityBadge: "BETA — WAITLIST OPEN",
      ...
      },
      {
        ...
        longDescription: "Eliminated manual data entry errors and targets an estimated 80% reduction in teacher admin reporting time (15+ hours weekly), pending formal retest. Now serves as the underlying daily teacher-to-parent update engine within the Chekki ecosystem.",
    ...
    projects: [
      {
        ...
        pmRole: "AI 프로덕트 매니저 & 엔지니어 (엔터프라이즈 음성 AI & 채점 엔진)",
        category: "Tools" as const,
        description: "실시간 WebRTC AI 페르소나 롤플레이 및 결정론적 11개 루브릭 채점으로 아웃바운드 텔레마케팅 1차 전화 면접을 자동화하는 엔터프라이즈 음성 AI 플랫폼. (NDA 준수)",
        longDescription: "NestJS 11 및 React 19 기반의 실시간 음성 AI 플랫폼. 외부 지원자는 1회용 무상태 매직링크로 접속하여 브라우저-OpenAI 간 직접 WebRTC 연결(<200ms 초저지연 및 서버 VAD)을 통해 AI 페르소나와 실시간 음성 롤플레이를 수행합니다. 통화 종료 후 비동기 파이프라인이 11개 세부 루브릭 코드 채점, BANTCQ 근거 추출, WPM 발화 텔레메트리 및 2주 맞춤 온보딩 로드맵을 산출합니다. 커스텀 RolesGuard 멀티테넌트 백오피스와 VOISOR 코칭 어시스턴트를 포함합니다. *고객사 기밀 식별 정보는 NDA 준수를 위해 익명화되었습니다.*",
        friction: "수동 후보자 전화 인터뷰 및 과도한 행정 공수로 인한 스크리닝 지연과 주관적인 채점 지표 발생.",
        flow: "Direct WebRTC 오디오 스트리밍, Push-to-Talk & 서버 VAD, 11개 루브릭 GPT-4o 비동기 채점 파이프라인, 토큰 로테이션 무상태 매직링크 인증 및 멀티테넌트 어드민 백오피스.",
        impactLabel: "음성 아키텍처",
        impactValue: "Direct WebRTC (<200ms 지연)",
        collaborationUrl: "mailto:jsn.benjamin@gmail.com?subject=Collaboration%20Inquiry%20-%20VodaBi%20Voice-AI%20Roleplay%20Platform",
        maturityBadge: "VODABI CASE STUDY",
        engineDetails: "기술 스택: React 19, TypeScript, Vite, NestJS 11, Prisma ORM 7 (MariaDB Driver Adapter), Direct WebRTC, OpenAI Realtime (gpt-4o-realtime-preview) + Post-Call GPT-4o, Docker Compose, Nginx, i18next",
        features: [
          "Realtime Voice Engine: Direct WebRTC 음성 스트리밍, 임시 토큰, push-to-talk & 서버 VAD (<200ms 지연)",
          "11-Code Rubric Evaluation: 11개 세부 루브릭 코드, BANTCQ 지표 & WPM 발화 분석 GPT-4o 비동기 채점",
          "VOISOR AI Coaching Assistant: 지원자 평가 데이터에 기반한 임베디드 코칭 챗 위젯",
          "Security & Magic Link Auth: 재초대 시 토큰 자동 로테이션을 지원하는 무상태 토큰화 매직링크",
          "Multi-Tenant RBAC Backoffice: 시나리오별 난이도 티어/루브릭, 온보딩 대기열 & 사내 공식 테스트 배정"
        ],
        tags: ["VodaBi B2B SaaS", "React 19", "WebRTC", "NestJS 11", "Prisma 7", "OpenAI Realtime", "GPT-4o"],
        imageUrl: "https://images.unsplash.com/photo-1589254065878-42c9da997008?q=80&w=2000&auto=format&fit=crop",
      },
      {
        id: "chekki-teacher",
        title: "Chekki Schools (체키 스쿨) — 커리큘럼 사전 탑재 및 학급 취약점 분석기",
