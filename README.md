...
| **[Chekki AI](https://chekki-ai.vercel.app/)** | EdTech OCR, Scanner & Report Studio | 🟢 **Live Shipped App** | **Instant mobile camera worksheet scanner** under zero-memory privacy bounds, plus a native curriculum-preseed → AI bilingual report → Korean Teacher review loop that replaced a separate Airtable/Make.com/Softr pipeline, saving **15+ hours/week**. | [Launch Live App ↗](https://chekki-ai.vercel.app/) |
